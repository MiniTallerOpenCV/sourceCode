...
while True:
    ...
    users_looking = 0  # Contador de usuarios mirando a la cámara
    ...
    # Cuadro esquina superior izquierda con número de usuarios mirando
    overlay = frame.copy()
