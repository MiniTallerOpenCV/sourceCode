...
# Variables de estado
stage = "num1"  # "num1", "operacion", "num2", "resultado"
num1 = None
num2 = None
operacion = None
resultado = None

# Función para detectar dedos
...
while True:
    ...
    # Número actual debajo del cuadro ROI
    ...
    if key == 32:  # Espacio
        if stage == "num1":
            ...
            # Continuar operación con el resultado como nuevo num1
            num1 = resultado
            stage = "operacion"
    
    # Leer operación del teclado
    if stage == "operacion":
